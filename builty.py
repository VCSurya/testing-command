...
builty_bp = Blueprint('Builty', __name__)

@builty_bp.route('/dashboard')
...
@builty_bp.route('/builty/builty-orders-list', methods=['GET'])
@login_required('Builty')
...
@builty_bp.route('/transport/cancel_order', methods=['POST'])
...
@builty_bp.route('/transport/done-transportation', methods=['POST'])
@login_required('Transport')
...
@builty_bp.route('/transport/my-transport-orders')
@login_required('Transport')
def my_pack_orders():
    return render_template('dashboards/transport/my_transport_orders.html')

@builty_bp.route('/my-transport-orders', methods=['GET'])
@login_required('Transport')
def my_orders():
    """
    Fetch the list of orders for the logged-in transport user.
